...
def load_params():
    ...
    """
    params = {}
    params_path =  str(current_dir_path) + "..../config/baseline_params.yaml" 
...
def load_prompts():
    ...
    """
    prompts = {}
    prompts_path = str(current_dir_path) + "..../config/baseline_prompts.yaml"
...
if __name__ == '__main__':
    ...
    output_folder = str(current_dir_path) + "/output/dataset/"
    ...
    for i in range(1, 156):
        ...
        folder_path = str(current_dir_path) + "/output/" + str(i)
        ...
        bbox_coords = pipline_test.test_pipeline(video_path, instruction, image_output, params, prompts, pipeline_output)
